class Unidadmap{
    ...
    constructor(id,nombre,cantidaddereservas,horariolunesi,horariolunesf,horariomartesi,horariomartesf,horariomiercolesi,horariomiercolesf
        ...
        this.horariomartesf=horariomartesf;
        this.horariomiercolesi=horariomiercolesi;
        this.horariomiercolesf=horariomiercolesf;
        this.horariojuevesi=horariojuevesi;
        this.horariojuevesf=horariojuevesf;
        this.horarioviernesi=horarioviernesi;
